    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-foreground/70 font-serif leading-relaxed">
              ...
              unwavering commitment to the English Bulldog breed.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-base md:text-lg font-bold text-secondary tracking-wide uppercase mb-3 font-sans">
                Our Story
              </p>
              ...
              <p className="text-foreground/70 font-serif mb-6 leading-relaxed">
                Heartland Bulls was born from a deep love for English Bulldogs
                that started over a decade ago. What began as a personal passion
                quickly grew into a mission—to raise bulldogs that are not only
                beautiful but healthy, well-tempered, and ready to become
                beloved family members.
              </p>
              <p className="text-foreground/70 font-serif mb-6 leading-relaxed">
                In 2015, we officially established Heartland Bulls in New
                Zealand, with families across New Zealand and Australia in mind.
                Since then, we have dedicated ourselves to learning, growing,
                and refining our breeding practices to ensure every puppy we
                raise meets the highest standards of health and temperament.
              </p>
              <p className="text-foreground/70 font-serif leading-relaxed">
                Our journey has been one of continuous improvement, guided by
                the latest veterinary research, breeder education, and most
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-4xl font-bold text-primary mb-6 font-heading">
                Breeding for Health & Happiness
              </h2>
              <p className="text-foreground/70 font-serif mb-6 leading-relaxed">
                Our mission is simple: to produce healthy, well-adjusted English
                Bulldogs that bring joy to families across New Zealand and
                Australia. We believe that responsible breeding is the
                foundation of a dog's lifelong health and happiness.
              </p>
              <p className="text-foreground/70 font-serif leading-relaxed">
                Every decision we make—from selecting breeding pairs to
                socializing puppies—is guided by our commitment to the breed's
                best interests. We don't cut corners, and we never compromise on
                the health or welfare of our dogs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="p-8 bg-card rounded-lg border-2 border-primary/10"
              >
      ...
      <section className="py-24 bg-primary/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-4xl font-bold text-primary mb-6 font-heading">
            To You and Your Bulldog
          </h2>
          <p className="text-lg text-foreground/70 font-serif mb-8 leading-relaxed">
            When you choose Heartland Bulls, you're not just getting a
            puppy—you're gaining a partner in your bulldog's lifelong journey.
            We commit to being there for you with advice, support, and guidance,
            from the day you take your puppy home and for years to come.
          </p>
          <Button
            asChild
            variant="outline"
